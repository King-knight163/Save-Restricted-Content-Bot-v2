...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/PLAYZ_HELP_BOT")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "> 💰 **Premium Price**:\n\n Starting from 200₹. Only redeem code and telegram stars are accepted no online payments. **__And remeber it no online payments accepted__** (terms and conditions apply).\n"
